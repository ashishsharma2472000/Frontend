                    ...
                    <div data-uia="password-reset-wrapper">
                      ...
                      <div className="reset-choice-container" data-uia="reset-choice-container">
                        <div className="ui-binary-input">
                          <input type="radio" className="reset-password-choice" name="resetPasswordChoice" id="bxid_resetPasswordChoice_email" value="email" tabindex="0" data-uia="email" checked   />

                          <label for="bxid_resetPasswordChoice_email" data-uia="label+email">Email</label>
                          <div className="helper"></div></div><div className="ui-binary-input">
                            <input type="radio" className="reset-password-choice" name="resetPasswordChoice" id="bxid_resetPasswordChoice_text" value="text" tabindex="0" data-uia="text" />
                            <label for="bxid_resetPasswordChoice_text" data-uia="label+text" >Text Message (SMS)</label>
                            <div className="helper"></div></div></div><div>
                              </div>
                              </div>
                              </div>
